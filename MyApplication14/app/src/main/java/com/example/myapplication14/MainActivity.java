...
import com.example.myapplication14.bean.UserInfo;
import com.example.myapplication14.database.UserDBHelper;
import com.example.myapplication14.util.DateUtil;
import com.example.myapplication14.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990093-邓黎明","学校用户"};
